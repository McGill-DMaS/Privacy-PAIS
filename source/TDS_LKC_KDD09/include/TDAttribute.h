...
// operations
    ...
    CTDConcepts* getFlattenConcepts() { return m_pFlattenConcepts; };
    CTDIntArray& getReqBits() { return m_reqBits; };
    bool isRelated(CTDVirtualID* pVID);
    bool calBits();
...
// attributes
    ...
    bool        m_bSensAttrib;      // Is it a sensitive attribue?
...
protected:    
    ...
    CTDConcepts* m_pFlattenConcepts;  
...
public:
    ...
    virtual ~CTDAttribs();
    void cleanup();
    CTDAttrib* findAttribute(LPCTSTR target);
